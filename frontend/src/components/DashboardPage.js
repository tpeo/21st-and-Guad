            ...
            >
              ...
              >
                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                  <Typography
                    align="center"
                    sx={{ fontWeight: 700, fontSize: 19, mb: 0, width: "100%" }}
                  >
                    {userData.name}
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography>
                    <Typography
                      variant="h3"
                      sx={{ fontWeight: 700, fontSize: 18, mb: 1, mt: -1 }}
                    >
                      Top Preferences
                    </Typography>
                    ...
                    <AmenitiesIcon
                      active="true"
                      iconName={userData.first_preference}
                      size="small"
                      marginRight={12}
                    />
                    <AmenitiesIcon
                      active="true"
                      iconName={userData.second_preference}
                      size="small"
                      marginRight={12}
                    />
                    <AmenitiesIcon
                      active="true"
                      iconName={userData.third_preference}
                      size="small"
                      marginRight={12}
                    />
